...
def extract_file(file_path: Path, filename: str, mime_type: str, *, ocr_strategy: str = "auto", ocr_backend: str = "auto"):
    extractor = choose_extractor(filename, mime_type)
    return extractor.extract(file_path, filename, mime_type, ocr_strategy=ocr_strategy, ocr_backend=ocr_backend)
